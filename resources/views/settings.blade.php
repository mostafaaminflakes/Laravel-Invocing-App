                                ...
                                <div class="row">
                                    ...
                                    <div class="col-5">
                                        <div class="input-group">
                                            <input type="text" name="vat" id="vat" class="form-control" value="{{ (old('vat') ? old('vat') : config('efc.vat') ) }}" placeholder="{{ __('VAT') }}">
                        ...
                        <div class="d-grid gap-1 mb-3">
                            ...
                            <div class="p-2">
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="serial_number" id="serial_number" class="form-control" value="{{ (old('serial_number') ? old('serial_number') : config('efc.serial') ) }}" placeholder="{{ __('Serial Number') }}" disabled>
