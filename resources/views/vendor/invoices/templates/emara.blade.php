                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-6" style="border:0px solid red; float: right;">
                                    <div class="fw-bold col-11 mb-3" style="font-weight:bold; border-bottom: 0.5px solid #dee2e6;">{{ __('Seller Information') }} - Seller Information</div>
                                    <div class="col-11">
                                        <table class="table table-seller-client">
                                            <tr>
                                                <td class="col-4">{{ __('Name') }}</td>
                                                <td class="text-center" style="font-size: 10px;">{{ settings()->get('sfc_seller_name') }}</td>
                                                <td class="text-start col-3">Name</td>
                                            </tr>
                                            <tr>
                                                <td>{{ __('VAT Number') }}</td>
                                                <td class="text-center">{{ settings()->get('sfc_seller_vat') }}</td>
                                                <td class="text-start">VAT Number</td>
                                            </tr>
                                            <tr>
                                                <td>{{ __('CR Number') }}</td>
                                                <td class="text-center">{{ settings()->get('sfc_cr_number') }}</td>
                                ...
                                <div class="col-6" style="border:0px solid red; float: right;">
                                    <div class="fw-bold col-12 mb-3" style="font-weight:bold; border-bottom: 0.5px solid #dee2e6;">{{ __('Client Information') }} - Client Information</div>
                                    <div class="col-12">
                                        <table class="table table-seller-client">
                                            <tr>
                                                <td class="col-3">{{ __('Name') }}</td>
                                                <td class="text-center">{{ $invoice->client_name }}</td>
                                                <td class="text-start col-3">Name</td>
                                            </tr>
                                            <tr>
                                                <td>{{ __('VAT Number') }}</td>
                                                <td class="text-center">{{ ! empty($invoice->client_vat_number) ? $invoice->client_vat_number : '--' }}</td>
                                                <td class="text-start">VAT Number</td>
                                            </tr>
                                            <tr>
                                                <td>{{ __('Project Name') }}</td>
                                                <td class="text-center">{{ $invoice->project_name }}</td>
                                                <td class="text-start">Project Name</td>
                                            </tr>
                                            <tr>
                                                <td>{{ __('Project Number') }}</td>
                                                <td class="text-center">{{ $invoice->project_number }}</td>
                            ...
                            <div class="fw-bold mt-3 mb-3" style="font-weight:bold; border-bottom: 0.5px solid #dee2e6;">{{ __('Invoice Details') }} - Invoice Details</div>
                            <table class="table table-bordered" id="dynamicTable">
                                ...
                                <tr class="totals-tr">
                                    <td rowspan="3" colspan="3">
                                        ...
                                        <p>&nbsp;</p>
                                        <p style="font-weight:bold;">{{ settings()->get('sfc_seller_name') }}</p>
