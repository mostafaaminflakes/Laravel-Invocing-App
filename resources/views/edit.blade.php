        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div><strong>{{ __('Edit Invoice') }}</strong></div>
                ...
                <div class="card-body">
                    ...
                    <form name="add_invoice_items" id="add_invoice_items">
                        @csrf
                        <input name="i_n" type="hidden" value="{{ $invoice->invoice_number }}">
                        @if($errors->any())
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <div>
                                    ...
                                    <input type="text" name="client_name" id="client_name" class="form-control" value="{{ (old('client_name') ? old('client_name') : $invoice->client_name ) }}" placeholder="{{ __('Name') }}">
                                </div>
                            ...
                            <div class="col-sm-4 mb-3">
                                <div>
                                    ...
                                    <input type="text" name="client_vat_number" id="client_vat_number" class="form-control" value="{{ (old('client_vat_number') ? old('client_vat_number') : $invoice->client_vat_number ) }}" placeholder="{{ __('VAT number') }}">
                                </div>
                                <div class="text-danger fs-6 err-msg"></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                                <div>
                                    ...
                                    <input type="text" name="project_name" id="project_name" class="form-control" value="{{ (old('project_name') ? old('project_name') : $invoice->project_name ) }}" placeholder="{{ __('Project Name') }}">
                                </div>
                                <div class="text-danger fs-6 err-msg"></div>
                            </div>
                            <div class="col-sm-4 mb-3">
                                <div>
                                    ...
                                    <input type="text" name="project_number" id="project_number" class="form-control" value="{{ (old('project_number') ? old('project_number') : $invoice->project_number ) }}" placeholder="{{ __('Project Number') }}">
                                </div>
                                <div class="text-danger fs-6 err-msg"></div>
                            </div>
                        </div>
                        <div>
                            ...
                            <input type=" text" name="notes" id="notes" class="form-control" value="{{ (old('notes') ? old('notes') : $invoice->notes) }}" placeholder="{{ __('Notes') }}">
                            <div class="text-danger fs-6 err-msg"></div>
                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="input-group">
                                        <input type="text" name="invoice_items[{{ $key }}][service_name]" placeholder="{{ __('Service name') }}" class="form-control{{ $errors->has('invoice_items.0.service_name') ? ' is-invalid' : '' }}" value="{{ (old('invoice_items[$key][service_name]') ? old('invoice_items[$key][service_name]') : $invoice_item->service_name ) }}" />
                                    </div>
                                    <div class="text-danger fs-6 err-msg"></div>
                                </td>
                                <td>
                                    <div class="input-group">
                                        <input type="text" name="invoice_items[{{ $key }}][unit]" placeholder="{{ __('Unit') }}" class="form-control{{ $errors->has('invoice_items.0.unit') ? ' is-invalid' : '' }}" value="{{ (old('invoice_items[$key][unit]') ? old('invoice_items[$key][unit]') : $invoice_item->unit ) }}" />
                                    </div>
                                    <div class="text-danger fs-6 err-msg"></div>
                                </td>
                                <td>
                                    <div class="input-group">
                                        <input type="text" name="invoice_items[{{ $key }}][completion]" placeholder="{{ __('Completion rate') }}" class="form-control{{ $errors->has('invoice_items.0.completion') ? ' is-invalid' : '' }}" value="{{ (old('invoice_items[$key][completion]') ? old('invoice_items[$key][completion]') : $invoice_item->completion ) }}" />
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" name="invoice_items[{{ $key }}][unit_price]" placeholder="{{ __('Unit price') }}" class="form-control{{ $errors->has('invoice_items.0.unit_price') ? ' is-invalid' : '' }}" value="{{ (old('invoice_items[$key][unit_price]') ? old('invoice_items[$key][unit_price]') : $invoice_item->unit_price ) }}" />
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" name="invoice_items[{{ $key }}][quantity]" placeholder="{{ __('Quantity') }}" class="form-control{{ $errors->has('invoice_items.0.quantity') ? ' is-invalid' : '' }}" value="{{ (old('invoice_items[$key][quantity]') ? old('invoice_items[$key][quantity]') : $invoice_item->quantity ) }}" />
                                    </div>
                                    <div class="text-danger fs-6 err-msg"></div>
                                </td>
                                <td>
                                    @if ($loop->first)
                                    <button type="button" name="add" id="add" class="btn btn-success">{{ __('Add') }}</button>
                                    @else
                                    <button type="button" class="btn btn-danger remove-tr">{{ __('Remove') }}</button>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
                        </table>
                        <button type="submit" class="btn btn-primary" id="submit">{{ __('Edit Invoice') }}</button>
                        <div id="spinner"></div>
                    </form>
                </div>
            </div>
